...
dtahun = pd.read_csv("./hasil/orderTahunan.csv")
dprodukTerjual = pd.read_csv("./hasil/produkTerjual.csv")
produkKategoriTerjual = pd.read_csv("./hasil/produkKategoriTerjual.csv")
transaksiBulanan = pd.read_csv("./hasil/transaksiBulanan.csv")
itemTransaksi = pd.read_csv("./hasil/itemTransaksi.csv")
customer = pd.read_csv("./hasil/customer.csv")
